var PracticeJavaScript = (function () {
'use strict';
...
var expectTypes = function (obj, types) {
  ...
  if (!types.some(function (expected) { return index$8(obj) === expected; })) {
    throw new index$4(
      'object tested must be ' + str + ', but ' + index$8(obj) + ' given'
    );
  }
};
...
var getMessage = function (obj, args) {
  var negate = flag(obj, 'negate')
    , val = flag(obj, 'object')
    , expected = args[3]
...
function extensiveDeepEqual(leftHandOperand, rightHandOperand, options) {
  ...
  var leftHandType = index$12(leftHandOperand);
  if (leftHandType !== index$12(rightHandOperand)) {
...
index$10.MemoizeMap = MemoizeMap_1;
...
var hasProperty = function hasProperty(name, obj) {
  var ot = index$8(obj);
...
var getPathInfo = function getPathInfo(path, obj) {
 ...
 * @api public
 */
var getPathValue = function(path, obj) {
...
var chai = createCommonjsModule(function (module) {
/*!
 * chai
 * Copyright(c) 2011-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
...
exports.AssertionError = index$4;
...
var arrays = [{
  ...
  tests: [{
    name: 'Correct output',
    test: function test(output) {
      return index_1.deepEqual(output, ['apple', 'banana']) === undefined;
    }
  }, {
    name: 'Returns an Array',
    test: function test(output) {
      return index_1.isArray(output) === undefined;
    }
  }, {
    name: 'Array has 2 items',
    test: function test(output) {
      return index_1.lengthOf(output, 2) === undefined;
    }
  }]
}, {
  ...
  tests: [{
    name: 'Correct output',
    test: function test(output) {
      return index_1.deepEqual(output, 'apple') === undefined;
    }
  }, {
    name: 'Returns a String',
    test: function test(output) {
      return index_1.isString(output) === undefined;
    }
  }]
}, {
  ...
  tests: [{
    name: 'Correct output',
    test: function test(output) {
      return index_1.deepEqual(output, 'orange') === undefined;
    }
  }, {
    name: 'Returns a String',
    test: function test(output) {
  ...
  tests: [{
    name: 'Correct output',
    test: function test(output) {
      return index_1.deepEqual(output, 'banana') === undefined;
    }
  }, {
    name: 'Returns a String',
    test: function test(output) {
  ...
  tests: [{
    name: 'Correct output',
    test: function test(output) {
      return index_1.deepEqual(output, ['applex', 'bananax']) === undefined;
    }
  }, {
    name: 'Returns an Array',
    test: function test(output) {
  ...
  tests: [{
    name: 'Correct output',
    test: function test(output) {
      return index_1.deepEqual(output, ['apple', 'banana', 'orange']) === undefined;
    }
  }, {
    name: 'Returns an Array',
    test: function test(output) {
    ...
    test: function test(output) {
      return index_1.lengthOf(output, 3) === undefined;
    }
  }]
}, {
  name: 'Array.pop()',
  ...
  tests: [{
    ...
    test: function test(output) {
      return index_1.deepEqual(output, ['banana', 'orange']) === undefined;
    }
  }, {
    name: 'Returns an Array',
    test: function test(output) {
  ...
  tests: [{
    name: 'Output must be correct',
    test: function test(output) {
      return index_1.deepEqual(output, ['strawberry', 'apple', 'banana', 'orange']) === undefined;
    }
  }, {
    ...
    test: function test(output) {
      return index_1.lengthOf(output, 4) === undefined;
    }
  }]
}, {
  name: 'Array.indexOf()',
  ...
  tests: [{
    name: 'Correct output',
    test: function test(output) {
      return index_1.deepEqual(output, 1) === undefined;
    }
  }, {
    name: 'Returns a Number',
    test: function test(output) {
      return index_1.isNumber(output) === undefined;
    }
  }]
}, {
  name: 'Array.concat()',
  ...
  tests: [{
    name: 'Correct output',
    test: function test(output) {
      return index_1.deepEqual(output, ['strawberry', 'banana', 'pear', 'peach']) === undefined;
    }
  }, {
    name: 'Returns an Array',
    test: function test(output) {
  ...
  tests: [{
    name: 'Correct output',
    test: function test(output) {
      return index_1.deepEqual(output, 'strawberry-banana') === undefined;
    }
  }, {
    name: 'Returns a String',
    test: function test(output) {
  ...
  tests: [{
    name: 'Correct output',
    test: function test(output) {
      return index_1.deepEqual(output, ['orange', 'lemon']) === undefined;
    }
  }, {
    name: 'Returns an Array',
    test: function test(output) {
  ...
  tests: [{
    name: 'Correct output',
    test: function test(output) {
      return index_1.deepEqual(output, ['banana', 'lemon', 'orange', 'strawberry']) === undefined;
    }
  }, {
    name: 'Returns an Array',
    test: function test(output) {
    ...
    test: function test(output) {
      return index_1.deepEqual(output[0], 'banana') === undefined;
    }
  }]
}, {
  name: 'Array.sort()',
  ...
  tests: [{
    name: 'Correct output',
    test: function test(output) {
      return index_1.deepEqual(output, 3) === undefined;
    }
  }, {
    name: 'Returns a Number',
    test: function test(output) {
  ...
  tests: [{
    name: 'Correct output',
    test: function test(output) {
      return index_1.deepEqual(output, [8, 13, 21]) === undefined;
    }
  }, {
    name: 'Returns an Array',
    test: function test(output) {
    ...
    test: function test(output) {
      return index_1.deepEqual(output[0], 8) === undefined;
    }
  }]
}, {
  name: 'Array.map()',
  ...
  tests: [{
    name: 'Correct output',
    test: function test(output) {
      return index_1.deepEqual(output, [5, 11, 13]) === undefined;
    }
  }, {
    name: 'Returns an Array',
    test: function test(output) {
    ...
    test: function test(output) {
      return index_1.deepEqual(output[0], 5) === undefined;
    }
  }, {
    name: 'Last item is 13',
    test: function test(output) {
      return index_1.deepEqual(output[output.length - 1], 13) === undefined;
    }
  }]
}, {
  name: 'Array.every()',
  ...
  tests: [{
    name: 'Correct output',
    test: function test(output) {
      return index_1.deepEqual(output, {
        evenNumbers: true,
    ...
    test: function test(output) {
      return index_1.isObject(output) === undefined;
    }
  }, {
    name: 'Object has 2 items',
    test: function test(output) {
      return index_1.lengthOf(Object.keys(output), 2) === undefined;
    }
  }, {
    name: 'First value is true',
    test: function test(output) {
      return index_1.isTrue(output.evenNumbers) === undefined;
    }
  }, {
    name: 'Second value is false',
    test: function test(output) {
      return index_1.isFalse(output.someOddNumbers) === undefined;
    }
  }]
}, {
  name: 'Array.some()',
  ...
  tests: [{
    ...
    test: function test(output) {
      return index_1.isFalse(output.evenNumbers) === undefined;
    }
  }, {
    name: 'Second value is true',
    test: function test(output) {
      return index_1.isTrue(output.someOddNumbers) === undefined;
    }
  }]
}
...
var arrays$1 = Object.freeze({
	default: arrays
});

var arrays$2 = ( arrays$1 && arrays ) || arrays$1;
...
(function () {
  var problems = [];
  problems.push.apply(problems, toConsumableArray(arrays$2.default));
  ...
  var localConfig = localStorage.getItem('js_practice_config');
  ...
  function updateTestStatus(testStatuses) {
    ...
    var testState = document.getElementById('test-suite');
    var testEls = [].slice.call(testState.querySelectorAll('.test-state'));
  ...
  function testSuite(init) {
    ...
    // Run stuff
    var output = getOutput(document.getElementById('code').value);
  ...
  function loadApp(config) {
    ...
    var debouncedInputValidation = debounce(function (e) {
